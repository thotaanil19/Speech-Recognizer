...
import edu.lu.sphinx.util.props.tools.GDLDumper;
import edu.lu.sphinx.util.props.tools.HTMLDumper;
    ...
    public void run() {
        ...
        if (showHTML) {
            try {
                ...
                logger.warn("Can't open " + htmlPath + ' ' + e);
            }
        }
        ...
        if (showGDL) {
            try {
                ...
                logger.warn("Can't open " + gdlPath + ' ' + e);
            }
        }
