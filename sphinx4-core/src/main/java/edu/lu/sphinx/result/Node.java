 ...
 * has a set of entering and leaving {@link edu.lu.sphinx.result.Edge edges}, connecting it to other nodes. One can get
 ...
 * Forward-Backward Algorithm. Refer to the {@link edu.lu.sphinx.result.Lattice#computeNodePosteriors
