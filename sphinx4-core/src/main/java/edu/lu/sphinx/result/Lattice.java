...
import edu.lu.sphinx.decoder.search.AlternateHypothesisManager;
import edu.lu.sphinx.decoder.search.Token;
import edu.lu.sphinx.linguist.dictionary.Pronunciation;
import edu.lu.sphinx.linguist.dictionary.Word;
import edu.lu.sphinx.util.LogMath;
import edu.lu.sphinx.util.TimeFrame;

/**
 * <p>
 * Provides recognition lattice results. Lattices are created from
 * {@link edu.lu.sphinx.result.Result Results} which can be partial or final.
 * </p>
 * <p>
 ...
 * {@link edu.lu.sphinx.result.Node Nodes} and
 * {@link edu.lu.sphinx.result.Edge Edges}. A Node that corresponds to a theory
 ...
 * {@link edu.lu.sphinx.decoder.search.WordPruningBreadthFirstSearchManager}
 ...
 * {@link edu.lu.sphinx.linguist.WordSearchState} returns false on the
 ...
 * {@link edu.lu.sphinx.linguist.lextree.LexTreeLinguist} and the
 * {@link edu.lu.sphinx.decoder.search.WordPruningBreadthFirstSearchManager}.
 * </i>
 * </p>
 * <p>
 * Lattices can also be created from a collapsed
 * {@link edu.lu.sphinx.decoder.search.Token} tree and its
 ...
 * {@link edu.lu.sphinx.decoder.search.WordPruningBreadthFirstSearchManager}. A
