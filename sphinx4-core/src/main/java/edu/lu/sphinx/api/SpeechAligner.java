...
import edu.lu.sphinx.alignment.TextTokenizer;
import edu.lu.sphinx.linguist.language.grammar.AlignerGrammar;
import edu.lu.sphinx.linguist.language.ngram.DynamicTrigramModel;
import edu.lu.sphinx.recognizer.Recognizer;
import edu.lu.sphinx.result.Result;
import edu.lu.sphinx.result.WordResult;
import edu.lu.sphinx.util.Range;
