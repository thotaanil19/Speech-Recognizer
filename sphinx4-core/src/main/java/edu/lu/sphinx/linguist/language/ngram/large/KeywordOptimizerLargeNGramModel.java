package edu.lu.sphinx.linguist.language.ngram.large;

import edu.lu.sphinx.linguist.language.ngram.large.LargeNGramModel;
 ...
 * @version 2010-12-16
 * @see LargeNGramModel
 * @see edu.lu.sphinx.linguist.language.ngram.KeywordOptimizerModel
 *
 */
