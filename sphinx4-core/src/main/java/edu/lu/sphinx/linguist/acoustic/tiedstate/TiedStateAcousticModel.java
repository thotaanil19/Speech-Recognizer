    ...
    */
    ...
    public HMM lookupNearestHMM(Unit unit, HMMPosition position,
        ...
        if (hmm == null) {
            ...
            if (ciUnit == null) {
                logger.warn("Can't find HMM for " + unit.getName());
            }
            assert ciUnit != null;
                                                     ...
                                                     HMMPosition position)
    {
        ...
        if (org.apache.log4j.Level.DEBUG .equals(logger.getLevel()))
            logger.warn("getCompositeSenoneSequence: "
                        + unit +
        ...
        for (Iterator<HMM> i = getHMMIterator(); i.hasNext();) {
            ...
            if (hmm.getPosition() == position) {
                ...
                if (hmmUnit.isPartialMatch(unit.getName(), context)) {
                    if (org.apache.log4j.Level.DEBUG .equals(logger.getLevel())) {
                        logger.warn("collected: " + hmm.getUnit());
                    }
        ...
        if (org.apache.log4j.Level.DEBUG .equals(logger.getLevel())) {
            logger.warn(unit + " consists of " + compositeSenones.size() + " composite senones");
            if (org.apache.log4j.Level.DEBUG .equals(logger.getLevel())) {
    ...
    protected void logInfo() {
        ...
        logger.debug("CompositeSenoneSequences: " +
