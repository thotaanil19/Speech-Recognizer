 ...
 *
 */
package edu.lu.sphinx.linguist.language.grammar;

import edu.lu.sphinx.util.ExtendedStreamTokenizer;
...
public class SimpleWordListGrammar extends Grammar implements Configurable {
    ...
    public SimpleWordListGrammar(String path, boolean isLooping, boolean showGrammar, boolean optimizeGrammar, boolean addSilenceWords, boolean addFillerWords, edu.lu.sphinx.linguist.dictionary.Dictionary dictionary) {
