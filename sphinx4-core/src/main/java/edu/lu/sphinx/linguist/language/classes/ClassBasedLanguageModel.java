...
public class ClassBasedLanguageModel implements LanguageModel {
     ...
     * (non-Javadoc)
     * @see
     * edu.lu.sphinx.util.props.Configurable#newProperties(edu.lu.sphinx.
     ...
     * @see
     * edu.lu.sphinx.linguist.language.ngram.LanguageModel#getProbability(
     * edu.lu.sphinx.linguist.WordSequence)
     */
