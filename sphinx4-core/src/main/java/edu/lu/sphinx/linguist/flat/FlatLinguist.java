 ...
 *
 */
package edu.lu.sphinx.linguist.flat;
...
import edu.lu.sphinx.linguist.language.grammar.GrammarArc;
import edu.lu.sphinx.linguist.language.grammar.GrammarNode;
import edu.lu.sphinx.util.Cache;
...
public class FlatLinguist implements Linguist, Configurable {
    ...
    * (non-Javadoc)
    *
    * @see edu.lu.sphinx.linguist.Linguist#allocate()
    */
    ...
    * (non-Javadoc)
    *
    * @see edu.lu.sphinx.linguist.Linguist#deallocate()
    */
    ...
    protected class FlatSearchGraph implements SearchGraph {
        ...
        * (non-Javadoc)
        *
        * @see edu.lu.sphinx.linguist.SearchGraph#getInitialState()
        */
        ...
        * (non-Javadoc)
        *
        * @see edu.lu.sphinx.linguist.SearchGraph#getNumStateOrder()
        */
