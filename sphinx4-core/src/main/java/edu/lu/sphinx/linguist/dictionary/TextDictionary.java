...
package edu.lu.sphinx.linguist.dictionary;
...
import edu.lu.sphinx.linguist.g2p.G2PConverter;
import edu.lu.sphinx.linguist.g2p.Path;
...
public class TextDictionary implements Dictionary {
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.linguist.dictionary.Dictionary#allocate()
     */
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.linguist.dictionary.Dictionary#deallocate()
     */
     ...
     * @see edu.lu.sphinx.linguist.dictionary.Word
     */
