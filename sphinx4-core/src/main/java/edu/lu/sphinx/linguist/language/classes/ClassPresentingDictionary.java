 ...
 */
package edu.lu.sphinx.linguist.language.classes;
...
public class ClassPresentingDictionary implements Dictionary {
    ...
    /* (non-Javadoc)
     * @see edu.lu.sphinx.linguist.dictionary.Dictionary#getSentenceStartWord()
     */
    ...
    /* (non-Javadoc)
     * @see edu.lu.sphinx.linguist.dictionary.Dictionary#getSentenceEndWord()
     */
    ...
    /* (non-Javadoc)
     * @see edu.lu.sphinx.linguist.dictionary.Dictionary#getSilenceWord()
     */
    ...
    /* (non-Javadoc)
     * @see edu.lu.sphinx.linguist.dictionary.Dictionary#getFillerWords()
     */
