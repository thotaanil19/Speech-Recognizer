 ...
 */
package edu.lu.sphinx.linguist.language.ngram;
...
public class InterpolatedLanguageModel implements LanguageModel {
     ...
     *
     * @see edu.lu.sphinx.linguist.language.ngram.LanguageModel#getProbability(edu.lu.sphinx.linguist.WordSequence)
     */
     ...
     * (non-Javadoc)
     * @see
     * edu.lu.sphinx.linguist.language.ngram.LanguageModel#getSmear(edu.lu
     ...
     * (non-Javadoc)
     * @see
     * edu.lu.sphinx.linguist.language.ngram.LanguageModel#getVocabulary()
     */
    ...
    /*
     * (non-Javadoc)
     * @see edu.lu.sphinx.linguist.language.ngram.LanguageModel#getMaxDepth()
     */
