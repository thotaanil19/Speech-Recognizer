...
public class LogSemiring extends Semiring {
     ...
     * 
     * @see
     * edu.lu.sphinx.fst.weight.Semiring#plus(edu.lu.sphinx.fst.weight.float,
     * edu.lu.sphinx.fst.weight.float)
     */
    @Override
     ...
     * 
     * @see
     * edu.lu.sphinx.fst.weight.Semiring#times(edu.lu.sphinx.fst.weight.float,
     * edu.lu.sphinx.fst.weight.float)
     */
    @Override
     ...
     * 
     * @see
     * edu.lu.sphinx.fst.weight.Semiring#divide(edu.lu.sphinx.fst.weight.float
     * , edu.lu.sphinx.fst.weight.float)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.fst.weight.Semiring#zero()
     */
    @Override
    public float zero() {
        return zero;
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.fst.weight.Semiring#one()
     */
    @Override
    public float one() {
        return one;
