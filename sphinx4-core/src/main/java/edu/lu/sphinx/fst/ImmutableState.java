 ...
 * 
 * holds its outgoing {@link edu.lu.sphinx.fst.Arc} objects in a fixed size
...
public class ImmutableState extends State {
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.fst.State#arcSort(java.util.Comparator)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.fst.State#addArc(edu.lu.sphinx.fst.Arc)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.fst.State#deleteArc(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.fst.State#getNumArcs()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.lu.sphinx.fst.State#getArc(int)
     */
    @Override
