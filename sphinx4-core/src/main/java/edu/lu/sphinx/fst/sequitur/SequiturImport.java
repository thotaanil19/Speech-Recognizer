 ...
 *
 */
package edu.lu.sphinx.fst.sequitur;
...
import edu.lu.sphinx.fst.Fst;
import edu.lu.sphinx.fst.semiring.Semiring;
import edu.lu.sphinx.fst.semiring.TropicalSemiring;
 ...
 * 
 * This program reads the XML and constructs a @link{edu.lu.sphinx.fst.Fst},
...
public class SequiturImport {
    ...
    public static class FSA {
        ...
        List<State> states;
        transient List<edu.lu.sphinx.fst.State> openFstStates;
         ...
         * 
         * @return an edu.lu.sphinx.fst.Fst built from the XML
         */
        public Fst toFst() {
            Fst openFst = new Fst(ring);
            openFst.setIsyms(inputAlphabet.toSymbols());
            openFst.setOsyms(outputAlphabet.toSymbols());
            openFstStates = new ArrayList<edu.lu.sphinx.fst.State>(
                    states.size());
            for (State state : states) {
                edu.lu.sphinx.fst.State openFstState = state
    ...
    public static class State {
         ...
         * arcs
         */
        public edu.lu.sphinx.fst.State toUnconnectedOpenFstState() {
            return new edu.lu.sphinx.fst.State(weight != null ? weight : 0.f);
        }
         ...
         */
        public void connectStates(List<edu.lu.sphinx.fst.State> openFstStates) {
            if (arcs != null)
                for (Arc arc : arcs) {
                    edu.lu.sphinx.fst.Arc openFstArc = arc
    ...
    public static class Arc {
        ...
        public edu.lu.sphinx.fst.Arc toOpenFstArc(
                List<edu.lu.sphinx.fst.State> openFstStates) {
            return new edu.lu.sphinx.fst.Arc(in, out, weight,
    ...
    public static void main(String... args) throws JAXBException, IOException {
        ...
        edu.lu.sphinx.fst.Fst fst = fsa.toFst();
        ...
        // edu.lu.sphinx.linguist.g2p.G2PConverter d = new
        // edu.lu.sphinx.linguist.g2p.G2PConverter(args[1]);
        // List<edu.lu.sphinx.linguist.g2p.Path> path =
