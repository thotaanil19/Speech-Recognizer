package edu.lu.sphinx.tools.endpoint;
...
import edu.lu.sphinx.frontend.util.WavWriter;
...
public class Segmenter {
    ...
    public static void main(String[] argv) throws MalformedURLException,
        ...
        if ((inputFile == null && inputCtl == null) || outputFile == null) {
            System.out
                    .println("Usage: java  -cp lib/batch.jar:lib/sphinx4.jar edu.lu.sphinx.tools.endpoint.Segmenter "
