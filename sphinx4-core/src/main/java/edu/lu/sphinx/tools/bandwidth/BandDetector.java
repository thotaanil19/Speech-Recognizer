...
package edu.lu.sphinx.tools.bandwidth;
...
import edu.lu.sphinx.frontend.transform.DiscreteFourierTransform;
import edu.lu.sphinx.frontend.util.AudioFileDataSource;
import edu.lu.sphinx.frontend.window.RaisedCosineWindower;
