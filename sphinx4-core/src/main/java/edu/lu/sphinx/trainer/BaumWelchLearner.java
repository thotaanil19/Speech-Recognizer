...
import edu.lu.sphinx.frontend.util.StreamCepstrumSource;
import edu.lu.sphinx.linguist.acoustic.HMMState;
import edu.lu.sphinx.linguist.acoustic.tiedstate.SenoneHMM;
import edu.lu.sphinx.linguist.acoustic.tiedstate.SenoneHMMState;
import edu.lu.sphinx.linguist.acoustic.tiedstate.trainer.TrainerScore;
...
public class BaumWelchLearner implements Learner {
    ...
    private static Logger logger =
            Logger.getLogger("edu.lu.sphinx.trainer.BaumWelch");
