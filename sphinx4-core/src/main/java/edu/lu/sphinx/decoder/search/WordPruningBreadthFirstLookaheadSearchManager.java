...
package edu.lu.sphinx.decoder.search;
...
import edu.lu.sphinx.decoder.pruner.Pruner;
import edu.lu.sphinx.decoder.scorer.AcousticScorer;
import edu.lu.sphinx.frontend.Data;
import edu.lu.sphinx.linguist.Linguist;
import edu.lu.sphinx.linguist.SearchState;
import edu.lu.sphinx.linguist.SearchStateArc;
import edu.lu.sphinx.linguist.WordSearchState;
import edu.lu.sphinx.linguist.acoustic.tiedstate.Loader;
import edu.lu.sphinx.linguist.acoustic.tiedstate.Sphinx3Loader;
import edu.lu.sphinx.linguist.allphone.PhoneHmmSearchState;
import edu.lu.sphinx.linguist.lextree.LexTreeLinguist.LexTreeHMMState;
import edu.lu.sphinx.linguist.lextree.LexTreeLinguist.LexTreeNonEmittingHMMState;
import edu.lu.sphinx.linguist.lextree.LexTreeLinguist.LexTreeWordState;
import edu.lu.sphinx.linguist.lextree.LexTreeLinguist.LexTreeEndUnitState;
...
public class WordPruningBreadthFirstLookaheadSearchManager extends WordPruningBreadthFirstSearchManager {
     ...
     * 
     * @see
     * edu.lu.sphinx.util.props.Configurable#newProperties(edu.lu.sphinx.util
     * .props.PropertySheet)
     */
    @Override
