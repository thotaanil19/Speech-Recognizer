...
import edu.lu.sphinx.util.Timer;
 ...
 * <p>
 * Each such data processor implements the {@link edu.lu.sphinx.frontend.DataProcessor} interface. Objects that
 * implements the {@link edu.lu.sphinx.frontend.Data} interface enters and exits the front end, and go between the
 ...
 * separately, and use the {@link #setDataSource(edu.lu.sphinx.frontend.DataProcessor) setDataSource} method to set it
 * as the input DataProcessor. In that case, the input DataProcessor will be prepended to the existing chain of
 * DataProcessors. One common input DataProcessor is the {@link edu.lu.sphinx.frontend.util.Microphone}, which
 ...
 * <p>
 * Another common input DataProcessor is the {@link edu.lu.sphinx.frontend.util.StreamDataSource}. It turns a Java
 ...
 * file:
 * <pre>
 * &lt;component name="mfcFrontEnd" type="edu.lu.sphinx.frontend.FrontEnd"&gt;
 ...
 * &lt;/component&gt;
 *
 * &lt;component name="preemphasizer" type="{@link edu.lu.sphinx.frontend.filter.Preemphasizer
 * edu.lu.sphinx.frontend.filter.Preemphasizer}"/&gt;
 * &lt;component name="windower" type="{@link edu.lu.sphinx.frontend.window.RaisedCosineWindower
 * edu.lu.sphinx.frontend.window.RaisedCosineWindower}"/&gt;
 * &lt;component name="dft" type="{@link edu.lu.sphinx.frontend.transform.DiscreteFourierTransform
 * edu.lu.sphinx.frontend.transform.DiscreteFourierTransform}"/&gt;
 * &lt;component name="melFilterBank" type="{@link edu.lu.sphinx.frontend.frequencywarp.MelFrequencyFilterBank2
 * edu.lu.sphinx.frontend.frequencywarp.MelFrequencyFilterBank}"/&gt;
 * &lt;component name="dct" type="{@link edu.lu.sphinx.frontend.transform.DiscreteCosineTransform
 * edu.lu.sphinx.frontend.transform.DiscreteCosineTransform}"/&gt;
 * &lt;component name="batchCMN" type="{@link edu.lu.sphinx.frontend.feature.BatchCMN
 * edu.lu.sphinx.frontend.feature.BatchCMN}"/&gt;
 * &lt;component name="featureExtractor" type="{@link edu.lu.sphinx.frontend.feature.DeltasFeatureExtractor
 * edu.lu.sphinx.frontend.feature.DeltasFeatureExtractor}"/&gt;
 * </pre>
 ...
 * <pre>
 * &lt;component name="scorer" type="edu.lu.sphinx.decoder.scorer.SimpleAcousticScorer"&gt;
 *     &lt;property name="frontend" value="mfcFrontEnd"/&gt;
 * &lt;/component&gt;
 * </pre>
 * In the SimpleAcousticScorer, the front end is obtained in the {@link edu.lu.sphinx.util.props.Configurable#newProperties
...
public class FrontEnd extends BaseDataProcessor {
    ...
    /* (non-Javadoc)
    * @see edu.lu.sphinx.frontend.DataProcessor#initialize(edu.lu.sphinx.frontend.CommonConfig)
    */
    @Override
