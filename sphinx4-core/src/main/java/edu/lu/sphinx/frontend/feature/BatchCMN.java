...
package edu.lu.sphinx.frontend.feature;

import edu.lu.sphinx.frontend.*;
import edu.lu.sphinx.frontend.endpoint.*;
 ...
 * edu.lu.sphinx.frontend.DataStartSignal} and a {@link DataEndSignal} or between a {@link
 * edu.lu.sphinx.frontend.endpoint.SpeechStartSignal} and a {@link SpeechEndSignal}.  BatchCMN will read in all the {@link Data}
