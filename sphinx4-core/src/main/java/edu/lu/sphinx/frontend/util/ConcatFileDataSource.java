...
import edu.lu.sphinx.util.BatchFile;
import edu.lu.sphinx.util.ReferenceSource;
 ...
 * edu.lu.sphinx.frontend.DataStartSignal DataStartSignal} will be placed before the start of the first file, and a
 * {@link edu.lu.sphinx.frontend.DataEndSignal DataEndSignal} after the last file. No DataStartSignal or DataEndSignal
 * will be placed between them. Optionally, silence can be added in-between the audio files by setting the property:
 * <pre>edu.lu.sphinx.frontend.util.ConcatFileDataSource.silenceFile</pre>
