...
import edu.lu.sphinx.frontend.denoise.Denoise;
import edu.lu.sphinx.frontend.frequencywarp.MelFrequencyFilterBank;
import edu.lu.sphinx.frontend.frequencywarp.MelFrequencyFilterBank2;
import edu.lu.sphinx.frontend.transform.*;
import edu.lu.sphinx.linguist.acoustic.tiedstate.KaldiLoader;
...
public class AutoCepstrum extends BaseDataProcessor {
    ...
    private void initDataProcessors() {
        try {
            ...
            logger.debug("Cepstrum component auto-configured as follows: "
                    + toString());
     ...
     * (non-Javadoc)
     * @see
     * edu.lu.sphinx.frontend.DataProcessor#initialize(edu.lu.sphinx.frontend
     * .CommonConfig)
     */
    @Override
